...
-- Photo storage
-- ---------------------------------------------------------------------------
-- Public bucket (photos are already shown to anyone in the app, so no point
-- gating reads) for profile photo uploads. Path convention is
-- <person_id>/<filename>, which the write policies below use to check
-- ownership without a separate table.
